...
def model():
    ...
    steerNet.compile(optimizer='adam', loss='mean_squared_error', metrics=['accuracy'])
...
def trainModel(model, imgIn, jstkOut):
    ...
    csv = CSVLogger('SteerNetL2Conv564.csv', separator='\n', append=True)
    #newmodel = load_model('SteerNetL2Conv564.h5')
